package myapp.t11.aloka.navigate.DeviceData
...
class CurrentLocation(private var context: Context) {
    ...
    fun getAddress() : String
    {
        ...
        else response = "no internet connection, your latitude is: " + lastLocation.latitude.toString() + ", longitude: " + lastLocation.longitude.toString()
        return response
    }
