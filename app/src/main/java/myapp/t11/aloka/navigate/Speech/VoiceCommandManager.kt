...
import myapp.t11.aloka.navigate.Activities.NaviMain
import myapp.t11.aloka.navigate.Activities.NaviMain.Companion.lastChosenStreet
import myapp.t11.aloka.navigate.DeviceData.DeviceDataManager
import myapp.t11.aloka.navigate.SettingsUtils.PreferredLanguage
...
class VoiceCommandManager(val audioManager: AudioManager, private val deviceDataManager: DeviceDataManager, private var context: Context) {
    ...
    fun navigationCommand()  {
        var message = ""
       (Settings.language == PreferredLanguage.English)
