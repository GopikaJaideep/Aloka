package myapp.t11.aloka.opencv.android;

import java.io.File;
import java.util.StringTokenizer;

import myapp.t11.aloka.opencv.core.Core;
import myapp.t11.aloka.opencv.engine.OpenCVEngineInterface;
...
class AsyncServiceHelper
{
            ...
            final LoaderCallbackInterface Callback)
    {
        ...
        Intent intent = new Intent("myapp.t11.aloka.opencv.engine.BIND");
        intent.setPackage("myapp.t11.aloka.opencv.engine");
     ...
     */
    protected static final String OPEN_CV_SERVICE_URL = "market://details?id=myapp.t11.aloka.opencv.engine";
