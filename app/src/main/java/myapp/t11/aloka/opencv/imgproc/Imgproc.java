...
import myapp.t11.aloka.opencv.core.MatOfFloat;
import myapp.t11.aloka.opencv.core.MatOfInt;
import myapp.t11.aloka.opencv.core.MatOfInt4;
import myapp.t11.aloka.opencv.core.MatOfPoint;
import myapp.t11.aloka.opencv.core.MatOfPoint2f;
import myapp.t11.aloka.opencv.core.Point;
import myapp.t11.aloka.opencv.core.Rect;
import myapp.t11.aloka.opencv.core.RotatedRect;
import myapp.t11.aloka.opencv.core.Scalar;
import myapp.t11.aloka.opencv.core.Size;
import myapp.t11.aloka.opencv.core.TermCriteria;
import myapp.t11.aloka.opencv.imgproc.CLAHE;
import myapp.t11.aloka.opencv.imgproc.LineSegmentDetector;
import myapp.t11.aloka.opencv.utils.Converters;
...
public class Imgproc {
    ...
    //
    // C++:  void cv::putText(Mat& img, String text, Point myapp.t11.aloka, int fontFace, double fontScale, Scalar color, int thickness = 1, int lineType = LINE_8, bool bottomLeftOrigin = false)
    //

    //javadoc: putText(img, text, myapp.t11.aloka, fontFace, fontScale, color, thickness, lineType, bottomLeftOrigin)
    public static void putText(Mat img, String text, Point aloka, int fontFace, double fontScale, Scalar color, int thickness, int lineType, boolean bottomLeftOrigin)
    {
        
        putText_0(img.nativeObj, text, aloka.x, aloka.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, bottomLeftOrigin);
        
        return;
    }

    //javadoc: putText(img, text, myapp.t11.aloka, fontFace, fontScale, color, thickness, lineType)
    public static void putText(Mat img, String text, Point aloka, int fontFace, double fontScale, Scalar color, int thickness, int lineType)
    {
        
        putText_1(img.nativeObj, text, aloka.x, aloka.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType);
        
        return;
    }

    //javadoc: putText(img, text, myapp.t11.aloka, fontFace, fontScale, color, thickness)
    public static void putText(Mat img, String text, Point aloka, int fontFace, double fontScale, Scalar color, int thickness)
    {
        
        putText_2(img.nativeObj, text,aloka.x, aloka.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
        
        return;
    }

    //javadoc: putText(img, text, myapp.t11.aloka, fontFace, fontScale, color)
    public static void putText(Mat img, String text, Point aloka, int fontFace, double fontScale, Scalar color)
    {
        
        putText_3(img.nativeObj, text, aloka.x, aloka.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3]);
...
public static Size getTextSize(String text, int fontFace, double fontScale, int thickness, int[] baseLine) {
    ...
    // C++:  void cv::putText(Mat& img, String text, Point myapp.t11.aloka, int fontFace, double fontScale, Scalar color, int thickness = 1, int lineType = LINE_8, bool bottomLeftOrigin = false)
    private static native void putText_0(long img_nativeObj, String text, double aloka_x, double aloka_y, int fontFace, double fontScale, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, boolean bottomLeftOrigin);
    private static native void putText_1(long img_nativeObj, String text, double aloka_x, double aloka_y, int fontFace, double fontScale, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType);
    private static native void putText_2(long img_nativeObj, String text, double aloka_x, double aloka_y, int fontFace, double fontScale, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);
    private static native void putText_3(long img_nativeObj, String text, double aloka_x, double aloka_y, int fontFace, double fontScale, double color_val0, double color_val1, double color_val2, double color_val3);
