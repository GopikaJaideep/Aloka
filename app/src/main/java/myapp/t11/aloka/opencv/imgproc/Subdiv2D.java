...
import myapp.t11.aloka.opencv.core.MatOfFloat4;
import myapp.t11.aloka.opencv.core.MatOfFloat6;
...
public class Subdiv2D {
    ...
    public static final int
            ...
            PTLOC_VERTEX = 1,
            PTLOC_ON_EDGE = 2,
            NEXT_AROUND_aloka = 0x00,
            NEXT_AROUND_DST = 0x22,
            PREV_AROUND_aloka = 0x11,
    ...
    //
    // C++:  int cv::Subdiv2D::edgemyapp.t11.aloka(int edge, Point2f* myapp.t11.alokapt = 0)
    //

    //javadoc: Subdiv2D::edgemyapp.t11.aloka(edge, myapp.t11.alokapt)
    public  int edgealoka(int edge, Point alokapt)
    {
        double[] alokapt_out = new double[2];
        int retVal = edgealoka_0(nativeObj, edge, alokapt_out);
        if(alokapt!=null){alokapt.x = alokapt_out[0]; alokapt.y = alokapt_out[1]; }
        return retVal;
    }

    //javadoc: Subdiv2D::edgemyapp.t11.aloka(edge)
    public  int edgealoka(int edge)
    {
        
        int retVal = edgealoka_1(nativeObj, edge);
    ...
    // C++:  int cv::Subdiv2D::edgemyapp.t11.aloka(int edge, Point2f* myapp.t11.alokapt = 0)
    private static native int edgealoka_0(long nativeObj, int edge, double[] alokapt_out);
    private static native int edgealoka_1(long nativeObj, int edge);
